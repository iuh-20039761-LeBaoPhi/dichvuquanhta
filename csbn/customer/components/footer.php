        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-2">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="about.php" class="text-white text-decoration-none opacity-75">Về Chúng Tôi</a></li>
                    <li class="mb-2"><a href="services.php" class="text-white text-decoration-none opacity-75">Dịch Vụ</a></li>
                    <li class="mb-2"><a href="contact.php" class="text-white text-decoration-none opacity-75">Liên Hệ</a></li>
                </ul>
            </div>
            <div class="col-lg-3">
...
<script src="/MamaCore/JS/style.js"></script>
</div>
</body>
</html>
<?php
