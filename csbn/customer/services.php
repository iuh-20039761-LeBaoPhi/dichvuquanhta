...
<section class="py-5" style="background: linear-gradient(135deg, #e3f2fd 0%, #FFFFFF 50%, #e8f5e9 100%);">
    <div class="container py-lg-5 text-center">
        <h1 class="display-3 fw-bold mb-3">Các Dịch Vụ Của Chúng Tôi <span style="color: #007bff; font-family: 'Pacifico', cursive;">MediCare</span></h1>
        <p class="lead text-muted mb-4">Dịch vụ chăm sóc sức khỏe Bệnh Nhân chuyên nghiệp và tận tâm</p>
        <div style="width: 60px; height: 3px; background-color: #007bff; margin: 0 auto;"></div>
    </div>
</section>
        ...
        <?php if (!empty($services)): ?>
            <?php foreach ($services as $index => $service): ?>
                ...
                <div class="row align-items-center mb-5 g-5 <?php echo $isReverse ? 'flex-lg-row-reverse' : ''; ?>">
                    ...
                    <div class="col-lg-6">
                        <h2 class="fw-bold display-6 mb-3" style="color: #007bff;"><?php echo htmlspecialchars($service['tendichvu']); ?></h2>
                        ...
                        <ul class="list-unstyled mb-4">
                            ...
                            ?>
                                <li style="padding: 8px 0; color: #555;"><i class="fas fa-check" style="color: #007bff; margin-right: 10px;"></i> <?php echo htmlspecialchars($item); ?></li>
                            <?php 
                                    endforeach;
                                } else {
                            ?>
                                <li style="padding: 8px 0; color: #555;"><i class="fas fa-check" style="color: #007bff; margin-right: 10px;"></i> Dịch vụ chất lượng cao</li>
                                <li style="padding: 8px 0; color: #555;"><i class="fas fa-check" style="color: #007bff; margin-right: 10px;"></i> Đội ngũ chuyên nghiệp</li>
                                <li style="padding: 8px 0; color: #555;"><i class="fas fa-check" style="color: #007bff; margin-right: 10px;"></i> Tận tâm với khách hàng</li>
                            <?php 
                                }
                            ?>
                        </ul>
                        <p class="fw-bold mb-3" style="color: #007bff; font-size: 1.1rem;">Giá: <?php echo $service['gia']; ?> VNĐ</p>
                        <button class="btn-book btn text-white rounded-pill px-4 py-2 shadow-sm" style="background-color: #007bff; border: none; cursor: pointer; transition: 0.3s;" 
...
<!-- Booking Section -->
<section class="py-5" style="background-color: #f3faff;">
    <div class="container py-5 text-center">
        ...
        style="background-color: #007bff; border: none; font-weight: 700; cursor: pointer; transition: 0.3s;" 
        onclick="window.location.href='contact.php'" onmouseover="this.style.backgroundColor='#0056b3'; this.style.transform='scale(1.05)';" onmouseout="this.style.backgroundColor='#007bff'; this.style.transform='scale(1)';">Đặt Lịch Ngay</button>
    </div>
</section>
...
<div id="bookingModal" style="display: none; position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.4); overflow-y: auto;">
    <div style="position: relative; margin: 10% auto; width: 90%; max-width: 500px;">
        <div class="bg-white rounded-4 p-4 shadow-lg" style="border: 1px solid #ddd; position: relative;">
            <span class="close" style="position: absolute; top: 20px; right: 25px; font-size: 32px; font-weight: bold; cursor: pointer; transition: all 0.3s; width: 35px; height: 35px; display: flex; align-items: center; justify-content: center; border-radius: 50%; line-height: 1; color: #aaa;" onclick="closeBookingModal()" onmouseover="this.style.border='1px solid #007bff'; this.style.color='#0056b3';" onmouseout="this.style.border='none'; this.style.color='#aaa';">&times;</span>

            <h2 class="mb-4" style="color: #007bff;"><i class="fas fa-calendar-plus"></i> Đặt Lịch Dịch Vụ</h2>
            ...
            <form id="bookingForm">
                ...
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #333;">Họ và tên: <span style="color: #007bff;">*</span></label>
                    <input type="text" id="customerName" name="customer_name" required placeholder="Nguyễn Văn A" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Quicksand', sans-serif; transition: 0.3s;" onfocus="this.style.borderColor='#007bff'; this.style.boxShadow='0 0 10px rgba(0, 123, 255, 0.2)';" onblur="this.style.borderColor='#ddd'; this.style.boxShadow='none';">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #333;">Số điện thoại: <span style="color: #007bff;">*</span></label>
                    <input type="tel" id="customerPhone" name="customer_phone" required placeholder="0912345678" pattern="[0-9]{10,11}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Quicksand', sans-serif; transition: 0.3s;" onfocus="this.style.borderColor='#007bff'; this.style.boxShadow='0 0 10px rgba(0, 123, 255, 0.2)';" onblur="this.style.borderColor='#ddd'; this.style.boxShadow='none';">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #333;">Email:</label>
                    <input type="email" id="customerEmail" name="customer_email" placeholder="email@example.com" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Quicksand', sans-serif; transition: 0.3s;" onfocus="this.style.borderColor='#007bff'; this.style.boxShadow='0 0 10px rgba(0, 123, 255, 0.2)';" onblur="this.style.borderColor='#ddd'; this.style.boxShadow='none';">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #333;">Ghi chú:</label>
                    <textarea id="customerNote" name="customer_note" rows="3" placeholder="Thời gian mong muốn, yêu cầu đặc biệt..." style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Quicksand', sans-serif; transition: 0.3s;" onfocus="this.style.borderColor='#007bff'; this.style.boxShadow='0 0 10px rgba(0, 123, 255, 0.2)';" onblur="this.style.borderColor='#ddd'; this.style.boxShadow='none';"></textarea>
                </div>
                ...
                <div style="display: flex; gap: 10px; margin-top: 20px;">
                    ...
                    <button type="submit" style="flex: 1; padding: 10px; border: none; border-radius: 50px; font-weight: 700; cursor: pointer; background-color: #007bff; color: white; transition: 0.3s;" onmouseover="this.style.backgroundColor='#d84374';" onmouseout="this.style.backgroundColor='#007bff';">
