...
<style>
    ...
    .invoice-card:active { background: #f0fff4; }
    .invoice-card .inv-id { color: #2e7d32; font-weight: 600; font-size: 0.95rem; }
    ...
    .invoice-card .inv-status { background: #1a4d2e; color: #fff; font-size: 0.7rem; padding: 4px 10px; border-radius: 999px; font-weight: 600; }
    .invoice-card .inv-service { color: #64748b; font-size: 0.85rem; margin-top: 2px; }
    .invoice-card .inv-price { color: #2e7d32; font-weight: 700; font-size: 1.1rem; text-align: right; margin-top: 4px; }
</style>
                                ...
                                <?php else: ?>
                                    <?php foreach ($paginatedRows as $item): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= format_date_display((string) ($item['ngay_bat_dau_kehoach'] ?? '')) ?></td>
                            ...
                            <?php foreach ($paginatedRows as $item): ?>
                                ...
                                <a href="chi-tiet-hoa-don.php" class="invoice-card"
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <div class="inv-date"><?= format_date_display((string) ($item['ngay_bat_dau_kehoach'] ?? '')) ?></div>
                                    </div>
