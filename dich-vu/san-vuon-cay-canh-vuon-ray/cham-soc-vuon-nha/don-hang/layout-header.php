...
// Đảm bảo không có session_user.php nào đã include trước đó
...
// Set charset header để tránh lỗi chữ
if (!headers_sent()) {
...
$userAvatarPath = '../assets/images/logo2.jpg';
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@500;600;700&family=Playfair+Display:ital,wght@0,700;1,700&display=swap"
        rel="stylesheet">
        ...
        <aside class="nv-admin-sidebar">
            <div class="nv-admin-brand-wrapper">
                <div class="d-flex align-items-center gap-2">
                    <div class="nv-admin-brand"><img src="../assets/images/logo2.jpg" width="22" alt="logo"></div>
                    <div class="fw-semibold lh-1 profile-name-text">Chăm Sóc Vườn</div>
                </div>
                <button class="btn p-0 d-lg-none" id="mobileMenuToggle" type="button">
                    <img class="nv-admin-avatar m-0" src="../assets/images/logo2.jpg" alt="toggle menu"
