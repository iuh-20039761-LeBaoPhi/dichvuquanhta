...
<div class="page-header-bar d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div class="d-flex align-items-center gap-3">
        <div style="width:40px;height:40px;border-radius:12px;background:var(--lime);display:flex;align-items:center;justify-content:center;">
            <i class="bi bi-pencil-square" style="color:var(--pg);font-size:1.1rem;"></i>
        </div>
        <div>
            <h2 class="h5 mb-0 fw-bold" style="color:var(--pg);">Sửa dịch vụ #<?= (int) $id ?></h2>
            <p class="text-muted small mb-0">Chỉnh sửa thông tin dịch vụ</p>
        </div>
    </div>
    ...
    <form id="editServiceForm" method="post" action="xu-ly-sua-dich-vu.php" enctype="multipart/form-data">
        ...
        <div class="row g-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="pricing_type_select" class="form-select fw-bold"
                                style="border-width:2px !important; border-color:var(--accent) !important;">
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm mb-3" style="border-left:3px solid var(--accent)!important;">
        ...
        <div class="card border-0 shadow-sm mt-3">
            <div class="card-body d-flex justify-content-between align-items-center gap-2">
                <a href="chi-tiet-dich-vu.php?id=<?= (int) $id ?>" class="btn btn-light border rounded-pill">
