...
try {
    ...
    $payload = json_encode(['table' => 'datlich_mevabe', 'limit' => 10000], JSON_UNESCAPED_UNICODE);
    $opts = [
        'http' => [
            'method' => 'POST',
                            ...
                            <?php foreach ($paginatedRows as $item): ?>
                                ...
                                <a href="chi-tiet-hoa-don-mevabe.php" class="invoice-card"
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <div class="inv-date">
                                            <?= date('d/m/Y', strtotime((string) ($item['ngay_bat_dau_kehoach'] ?? 'now'))) ?></div>
                                    </div>
                                    ...
                                    <div class="inv-service">
                                        <?= htmlspecialchars((string) ($item['dich_vu'] ?? 'Dịch vụ'), ENT_QUOTES, 'UTF-8') ?></div>
