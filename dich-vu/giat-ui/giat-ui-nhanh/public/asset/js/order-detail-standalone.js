(function (window, document) {
  ...
  function renderReviewMedia(container, files) {
    ...
    list.forEach(function (item, index) {
      ...
      if (isDriveId) {
        ...
        const containerId = "drive-review-" + item + "-" + index;
  ...
  async function updateOrderRow(orderId, payload) {
    ...
    if (payload && payload.ngayhoanthanh) {
      try {
        await new Promise(function (resolve) {
          if (!navigator.geolocation || typeof window.krud !== "function") return resolve();
            ...
            function (pos) {
              ...
              fetch(
                ...
                .then(function (data) {
                  ...
                  var providerId = order.idnhacungcap || (order.nhacungcap && (order.nhacungcap.id || order.nhacungcap.idnhacungcap)) || null;
