    ...
    return {
      ...
      orderLinks: Array.from(
        document.querySelectorAll(
          '.nav-menu .auth-user-dropdown a[href*="khachhang/danh-sach-don-hang.html"], .nav-menu .auth-user-dropdown a[href*="nguoidung/danh-sach-don-hang.html"]',
        ),
      ),
      dashboardLinks: Array.from(
        document.querySelectorAll(
          '.nav-menu .auth-user-dropdown a[href*="nhacungcap/danh-sach-don-hang.html"], .nav-menu .auth-user-dropdown a[href*="nguoidung/danh-sach-don-nhan.html"]',
        ),
      ),
    };
  }
