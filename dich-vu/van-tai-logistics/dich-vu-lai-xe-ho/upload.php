...
// ============================================
// === ĐÂY LÀ DÒNG CẦN SỬA: $folderKey ===
// === 6  = Ảnh dịch vụ Lái xe hộ        ===
// === 26 = Ảnh đặt lịch / đánh giá       ===
// === 33 = Ảnh avatar đăng ký            ===
// ============================================
$folderKey = 6; // ← SỬA SỐ NÀY THÀNH 6, 26, hoặc 33

$data = json_encode([
    'name' => $name,
    'file' => $fileContent,
    'type' => $mime,
    'folderKey' => $folderKey  // ← ĐÃ THÊM DÒNG NÀY
]);
