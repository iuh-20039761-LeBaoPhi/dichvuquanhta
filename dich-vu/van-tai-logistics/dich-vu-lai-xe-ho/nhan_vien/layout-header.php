...
$userName = $_SESSION['user']['hovaten'] ?? 'Tài xế';
...
$pageTitle = $pageTitle ?? 'Driver Panel - Dịch Vụ Thuê Tài Xế';
?>
<!DOCTYPE html>
<html lang="vi">
        ...
        <aside class="nv-admin-sidebar">
            <div class="nv-admin-brand-wrapper">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="fw-bold lh-1 profile-name-text">Dịch Vụ Thuê Tài Xế</div>
                </div>
            ...
            <nav id="nvSidebarMenu" class="list-group list-group-flush mt-3">
                ...
                <a href="thong-tin-tai-xe.php" class="list-group-item <?php echo $current_page == 'thong-tin-tai-xe.php' || $current_page == 'sua-thong-tin-tai-xe.php' ? 'active' : ''; ?>" data-page="thong-tin-tai-xe.php">
                    <i class="bi bi-person-badge"></i> <span>Thông tin cá nhân</span>
                </a>
                <a href="danh-sach-don-hang.php" class="list-group-item <?php echo $current_page == 'danh-sach-don-hang.php' ? 'active' : ''; ?>" data-page="danh-sach-don-hang.php">
            ...
            <header class="nv-admin-topbar">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" style="border-radius: 15px;">
                        <li><a class="dropdown-item py-2 px-3" href="thong-tin-tai-xe.php"><i class="bi bi-person me-2"></i>Thông tin tài khoản</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger py-2 px-3" href="../logout.php"><i class="bi bi-box-arrow-right me-2"></i>Đăng xuất</a></li>
                    </ul>
                </div>
            </header>
