...
function giaohang_admin_api_normalize_rows($decoded) {
    if (!is_array($decoded)) {
        return [];
    }
...
function giaohang_admin_api_list_table($table) {
    ...
    return [
        'rows' => giaohang_admin_api_normalize_rows($decoded),
        'error' => '',
    ];
}

function giaohang_admin_shared_login_url() {
    return '../../../../../public/admin-login.html';
}

function giaohang_admin_clear_shared_admin_cookies() {
    setcookie('admin_e', '', time() - 3600, '/');
    setcookie('admin_p', '', time() - 3600, '/');
}

function giaohang_admin_find_shared_admin_account($email, $password) {
    ...
    $apiResult = giaohang_admin_api_list_table('admin');
