...
<div class="pricing-grid">
                ...
                <table class="pricing-table pricing-summary-table">
                    ...
                    <tbody>
                        <tr data-pricing-row="instant">
                            ...
                            <td><button type="button" class="pricing-action-btn" data-open-modal="modal-edit-instant"><i
        ...
        <div class="pricing-card__body" id="section-service-fee-details">
            <div class="pricing-summary-group">
                <div class="pricing-summary-group__head">
                    ...
                    <button type="button" class="pricing-action-btn" data-open-modal="modal-add-service-time"><i
            ...
            <div class="pricing-summary-group">
                <div class="pricing-summary-group__head">
                    ...
                    <button type="button" class="pricing-action-btn" data-open-modal="modal-add-weather"><i
                            class="fa-solid fa-plus"></i> Thêm</button>
                </div>
                <div class="pricing-table-wrap">
                    <table class="pricing-table pricing-summary-table pricing-table--service-fees">
    ...
    <section class="pricing-card" id="section-cod">
        <div class="pricing-card__head">
            ...
            <div class="pricing-card__actions">
                <button type="button" class="btn-secondary pricing-open-btn" data-open-modal="modal-edit-cod"><i
                        class="fa-solid fa-pen-to-square"></i> Chỉnh chi
                    tiết</button>
            </div>
        </div>
                ...
                <table class="pricing-table pricing-summary-table">
                    ...
                    <tbody>
                        <tr data-pricing-row="cod" data-row-key="thuho">
                            ...
                            <td><button type="button" class="pricing-action-btn" data-open-modal="modal-edit-cod"><i
                                        class="fa-solid fa-pen"></i>
                                    Sửa</button></td>
                        </tr>
    ...
    <section class="pricing-card pricing-card--wide" id="section-vehicle">
        <div class="pricing-card__head">
            ...
            <div class="pricing-card__actions">
                <button type="button" class="btn-secondary pricing-open-btn" data-open-modal="modal-add-vehicle"><i
                        class="fa-solid fa-plus"></i> Thêm phương
                    tiện mới</button>
            </div>
        </div>
    ...
    <section class="pricing-card" id="section-goods">
        <div class="pricing-card__head">
            ...
            <div class="pricing-card__actions">
                <button type="button" class="btn-secondary pricing-open-btn" data-open-modal="modal-add-goods"><i
                        class="fa-solid fa-plus"></i> Thêm loại hàng
                    mới</button>
            </div>
        </div>
