    ...
    <main class="admin-container">
        ...
        <div class="pricing-shell" data-active-version-id="<?php echo htmlspecialchars((string) $pricingActiveVersionId, ENT_QUOTES, 'UTF-8'); ?>">
            <div class="pricing-content">
                <div class="pricing-source-panel <?php echo $pricingStorageSource === 'krud' ? 'is-krud' : 'is-cache'; ?>">
                    <div>
                        <div class="pricing-source-panel__title">Nguồn bảng giá: <?php echo htmlspecialchars($pricingSourceLabel, ENT_QUOTES, 'UTF-8'); ?></div>
                        <p class="pricing-source-panel__desc"><?php echo htmlspecialchars($pricingSourceDescription, ENT_QUOTES, 'UTF-8'); ?></p>
                    </div>
                </div>
                ...
                <div class="pricing-sync-panel" data-pricing-sync-panel>
                    <div>
                        ...
                        <p class="pricing-sync-panel__status" data-pricing-sync-status>
                            Chưa kiểm tra. Dùng nút này để so sánh dữ liệu active KRUD với JSON cache public/data/pricing-data.json.
                        </p>
                    </div>
                    <div class="pricing-sync-panel__actions">
                        <button type="button" class="pricing-action-btn pricing-action-btn--primary" data-pricing-sync-check>
