...
(function () {
    ...
    function _createModal() {
        ...
        wrapper.innerHTML = [
            ...
            '            Thông Tin Đặt Xe',
            '          </h5>',
            '          <img src="public/assets/images/thue-xe-logo-header-navigation.jpg" alt="Thuê Xe" class="tx-bk-logo">',
            '        </div>',
    ...
    function _loadContent() {
        ...
        $body.load('dat-lich.html #bookingFormContent', function (_response, status) {
            if (status === 'error') {
                $body.html(
