    ...
    if(cars.length === 0) {
        container.innerHTML = `
            <div class="col-12 text-center py-5">
                ...
                <a href="tim-kiem.html" class="btn btn-gradient mt-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card car-card h-100">
                    <div class="position-relative">
                        <img src="public/assets/images/cars/${car.main_image}"
                             class="card-img-top"
                             alt="${car.name}"
                             onerror="this.src='public/assets/images/cars/thue-xe-xe-anh-mac-dinh-fallback.jpg'">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="chi-tiet-xe.html?type_id=${car.type_id || car.id}" class="btn btn-gradient-secondary btn-sm">
                                Xem chi tiết
                            </a>
                        </div>
                    </div>
...
function setupFilterForm() {
    document.getElementById('searchFilterForm').addEventListener('submit', (e) => {
        ...
        window.location.href = `tim-kiem.html${query.toString() ? `?${query.toString()}` : ''}`;
    });
}
