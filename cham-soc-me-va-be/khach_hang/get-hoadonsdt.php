...
/**
 * Ham dung chung: lay tat ca hoa don datlich_mevabe theo so dien thoai session.
...
/** Lay thong tin nhan vien theo id_nhacungcap tu bang nhacungcap_mevabe. */
function getNhanVienById(int $nhanVienId): ?array
{
    ...
    $rows = list_table_rows('nhacungcap_mevabe');
    foreach ($rows as $row) {
