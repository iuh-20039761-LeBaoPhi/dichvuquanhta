...
$result = khoa_nhan_vien($id);
$query = $result['success']
    ? '?ok=1&msg=' . rawurlencode((string)($result['message'] ?? 'Khoa tai khoan thanh cong.'))
    : '?ok=0&msg=' . rawurlencode((string)($result['message'] ?? 'Khoa tai khoan that bai.'));
