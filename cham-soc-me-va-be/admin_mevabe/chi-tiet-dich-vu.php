...
<?php else: ?>
	...
	<div class="row g-3">
		<div class="col-12 col-xl-7">
			<div class="card border-0 shadow-sm h-100">
				...
				<div class="card-body">
					...
					<div class="mb-3">
						<small class="text-secondary">Chú thích hình ảnh</small>
		...
		<div class="col-12 col-xl-5">
			<div class="card border-0 shadow-sm mb-3">
				...
				<div class="card-body text-center">
					<?php if ($imageSrc !== ''): ?>
						<img src="<?= admin_h($imageSrc) ?>" class="img-fluid rounded" alt="<?= admin_h((string)($row['alt'] ?? 'Dịch vụ')) ?>">
					<?php else: ?>
			...
			<div class="card border-0 shadow-sm">
				<div class="card-header bg-white fw-semibold">Danh sách công việc bao gồm</div>
				<div class="card-body">
		...
		<div class="col-12">
			<div class="card border-0 shadow-sm">
				<div class="card-header bg-white fw-semibold">Bảng giá</div>
				<div class="card-body">
