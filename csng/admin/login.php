...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            <h2 class="text-3xl font-semibold text-gray-900"><span class="text-danger" style="font-family: 'Pacifico', cursive; color: #2e7d32;">ElderlyCare</span> Admin</h2>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <form method="POST" class="space-y-6">
                ...
                <button
                    type="submit"
                    class="w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 transition-colors">
                Đăng nhập
                </button>
            </form>
        </div>
