<?php
function renderHeader($title = "ElderlyCare - Chăm Sóc Người Cao Tuổi & Người Già Đơn Côi") {
?>
<!DOCTYPE html>
<html lang="vi">
<head>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navMenu">
                <ul class="navbar-nav align-items-center gap-3">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a href="contact.php" class="btn text-white rounded-pill px-4 py-2 shadow-sm" style="background-color:#2e7d32;">Đặt Lịch Chăm Sóc</a>
                    </li>
                </ul>
            </div>
        </div>
