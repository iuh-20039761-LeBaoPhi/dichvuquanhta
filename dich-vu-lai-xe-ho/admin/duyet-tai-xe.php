...
$result = duyet_tai_xe($id);
$query = $result['success']
    ? '?ok=1&msg=' . rawurlencode((string)($result['message'] ?? 'Duyệt tài xế thành công.'))
    : '?ok=0&msg=' . rawurlencode((string)($result['message'] ?? 'Duyệt tài xế thất bại.'));
