...
<style>
	...
	.topbar {
		...
		align-items: center;
		padding: 20px 24px;
		background: linear-gradient(102deg, #1b5e20 0%, #2e7d32 58%, #66bb6a 100%);
		color: #fff;
	...
	.invoice-status-badge.success {
		background-color: rgb(27, 192, 131);
		color: #fff;
	}

	.invoice-status-badge.warning {
		background-color: rgba(217, 228, 16, 0.996);
		color: #000;
	}
			...
			<section id="mainGrid" class="grid">
				...
				<article class="panel" id="panelTime">
					...
					<div style="display:grid;gap:6px;">
						...
						<div
							style="width:100%;height:21px;border-radius:999px;overflow:hidden;background:linear-gradient(180deg,#e3f0ff 0%,#ffffff 100%);border:1px solid #0d962bff;box-shadow:inset 0 1px 2px rgb(255, 255, 255);">
						...
						<p id="progressHint" class="hint"
							style="font-size:12px;margin-top:-2px; color: rgba(28, 58, 27, 1)ff; font-weight: 700;">
					...
					<div
						...
						<div
							style="display:grid;grid-template-columns:repeat(3,1fr);background:#1b5e20;color:#ffff;font-size:11px;font-weight:700;text-align:center;">
							<span style="padding:7px 5px;border-right:1px solid rgba(255,255,255,0.1);">Ngày bắt đầu dự
								kiến</span>
							<span style="padding:7px 5px;border-right:1px solid rgba(255,255,255,0.1);">Ngày kết thúc dự
								kiến</span>
						...
						<div
							...
							<span
								style="padding:7px 5px;border-right:1px solid #e5edf5; color: #1f5328ff;"><?= admin_h($row['ngay_bat_dau_kehoach'] ?? '---') ?></span>
							<span
								style="padding:7px 5px;border-right:1px solid #e5edf5; color: #1f5322ff;"><?= admin_h($row['ngay_ket_thuc_kehoach'] ?? '---') ?></span>
					...
					<div class="d-flex align-items-center flex-wrap" style="gap:8px; margin-bottom: 8px;">
						...
						<span class="badge warning"
							style="background:#fff3e0; color:#e67e22; border:1px solid #ffe0b2;"><?= admin_h($statusText) ?></span>
					</div>

					<div
						style="border:1px solid #e5edf5;border-radius:8px;overflow:hidden;background:#f8fbff; margin-bottom: 8px;">
						<div
							style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));background:#1b5e20;color:#ffff;font-size:12px;font-weight:700;">
						...
						<div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));">
							<div style="border-right:1px solid #e5edf5;">
								<div class="d-flex justify-content-between align-items-center"
									...
									<span
										style="color:#1f3853;font-weight:700;"><?= admin_h($row['gio_bat_dau_kehoach'] ?? '--:--') ?></span>
								</div>
								<div class="d-flex justify-content-between align-items-center"
									...
									<span
										style="color:#1f3853;font-weight:700;"><?= admin_h($row['gio_ket_thuc_kehoach'] ?? '--:--') ?></span>
								</div>
							</div>
							<div>
								<div class="d-flex justify-content-between align-items-center"
									...
									<span style="color:#000000;font-weight:700;">Bắt đầu</span>
									<span
										style="color:#1f3853;font-weight:700;"><?= admin_h($row['thoigian_batdau_thucte'] ?? '---') ?></span>
								</div>
								<div class="d-flex justify-content-between align-items-center"
									style="gap:8px;padding:7px 10px;border-top:1px solid #e3ecf7;font-size:12px;">
									<span style="color:#000000;font-weight:700;">Kết thúc</span>
									<span
										style="color:#1f3853;font-weight:700;"><?= admin_h($row['thoigian_ketthuc_thucte'] ?? '---') ?></span>
								</div>
							</div>
						</div>
					</div>
				...
				<article class="panel" id="panelCustomer">
					...
					<div class="profile-body">
						<img class="profile-avatar"
							src="../<?= admin_h($row['avatar_khachhang'] ?? 'assets/logo-cham-soc-benh-nhan.png') ?>"
							alt="Customer">
				...
				<article class="panel" id="panelStaff">
					...
					<div class="profile-body">
						<img class="profile-avatar"
							src="../<?= admin_h($row['avatar_ncc'] ?? 'assets/logo-cham-soc-benh-nhan.png') ?>" alt="Staff">
						<div class="profile-main">
